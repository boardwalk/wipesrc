...
!MESSAGE 
!MESSAGE NMAKE /f "RigsSet.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/RigsSet.exe $(OUTDIR)/RigsSet.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"RigsSet.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/RigsSet.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"RigsSet.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"RigsSet.pdb" /c 
CPP_OBJS=.\WinDebug/
...
$(INTDIR)/dinstall.res :  $(SOURCE)  $(DEP_DINST) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
...
SOURCE=.\dinstall.c
DEP_DINSTA=\
	c:\gdk\sdk\inc\dsetup.h\
	.\dinstall.h

$(INTDIR)/dinstall.obj :  $(SOURCE)  $(DEP_DINSTA) $(INTDIR)
