...
* GTE read macros
*/
#define read_sz_fifo3(r1, r2, r3) \
  mfc2 r1, $17;                   \
  mfc2 r2, $18;                   \
  mfc2 r3, $19;                   \
  nop

#define read_sz_fifo4(r1, r2, r3, r4) \
  mfc2 r1, $16;                       \
  mfc2 r2, $17;                       \
  mfc2 r3, $18;                       \
  mfc2 r4, $19;                       \
...
#define read_sxsy_fifo3(r1, r2, r3) \
  mfc2 r1, $12;                     \
  mfc2 r2, $13;                     \
  mfc2 r3, $14;                     \
  nop

#define read_sxsy0(r1) \
  mfc2 r1, $12;        \
  nop

#define read_sxsy1(r1) \
  mfc2 r1, $13;        \
  nop

#define read_sxsy2(r1) \
  mfc2 r1, $14;        \
  nop

#define read_rgb_fifo(r1, r2, r3) \
  mfc2 r1, $20;                   \
  mfc2 r2, $21;                   \
  mfc2 r3, $22;                   \
  nop
...
* GTE set macros
*/
#define set_trans_matrix(r1, r2, r3) \
  ctc2 r1, $5;                       \
  ctc2 r2, $6;                       \
  ctc2 r3, $7;                       \
  nop
