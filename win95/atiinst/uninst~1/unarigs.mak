...
!MESSAGE 
!MESSAGE NMAKE /f "unarigs.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/unarigs.exe $(OUTDIR)/unarigs.bsc
...
CPP_PROJ=/nologo /ML /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"unarigs.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
$(OUTDIR)/unarigs.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
CPP_PROJ=/nologo /ML /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"unarigs.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"unarigs.pdb" /c 
CPP_OBJS=.\WinDebug/
...
$(INTDIR)/dinstall.obj :  $(SOURCE)  $(DEP_DINST) $(INTDIR)
...
$(INTDIR)/dinstall.res :  $(SOURCE)  $(DEP_DINSTA) $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
